	...
	def bulk_update(
		...
		*,
		...
		for __ in range(0, total_docs, chunk_size):
			...
			self.build_and_run_bulk_update_query(doctype, doc_chunk, modified_dict, debug)

	@staticmethod
	def build_and_run_bulk_update_query(doctype: str, doc_updates: dict, modified_dict=None, debug=False):
		"""
		:param doctype: DocType to update
		:param doc_updates: Dictionary of key (docname) and values to update
		:param debug: Print the query in the developer / js console.
